...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_prefix', type=str, default='./quora/logs/SentenceMatch.quora',  help='Prefix to the models.')
    parser.add_argument('--in_path', type=str, default='./quora/test.tsv', help='the path to the test file.')
    parser.add_argument('--out_path', type=str, default='./quora/result.json',  help='The path to the output file.')
    parser.add_argument('--word_vec_path', type=str, default='./quora/wordvec4_768.txt', help='word embedding file for the input file.')
    ...
    with tf.Graph().as_default():
        ...
        restore_global_step=29
        saver.restore(sess, best_path+'-%d'% restore_global_step)
        print("DONE!")
